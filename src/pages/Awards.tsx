      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16" data-aos="fade-up">
          <div className="relative bg-gray-100 rounded-2xl overflow-hidden shadow-lg">
            ...
            <button
              onClick={prevSlide}
              className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-purple-100 text-gray-800 p-2 rounded-full shadow-lg transition-all duration-300 hover:scale-110"
            >
              <ChevronLeft size={24} />
            </button>
            <button
              onClick={nextSlide}
              className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-purple-100 text-gray-800 p-2 rounded-full shadow-lg transition-all duration-300 hover:scale-110"
            >
          ...
          <div data-aos="fade-right">
            ...
            <div className="space-y-4">
              {professionalCerts.map((cert) => (
                <div key={cert.id} className="bg-white rounded-lg p-4 hover:bg-purple-50 transition-all duration-300 shadow-sm hover:shadow-md transform hover:-translate-y-1">
