      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          <div className="flex items-center justify-center mb-8">
            <Building className="w-6 h-6 text-blue-700 mr-3" />
        ...
        <div>
          <div className="flex items-center justify-center mb-8">
            <Award className="w-6 h-6 text-green-700 mr-3" />
            <h2 className="text-2xl font-semibold text-gray-900">
            ...
            {internationalTraining.map((training, index) => (
              <div key={index} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                <div className="flex items-center mb-3">
                  <Award className="w-5 h-5 text-green-700 mr-2" />
                  <span className="text-sm font-medium text-green-700">{training.period.split(' to ')[0].split('-')[2] || 'Training'}</span>
                </div>
